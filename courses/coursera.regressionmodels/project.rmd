...
Ths report looks at the correlation coefficient and the regression model to answer these questions. Results indicated that there is a correlation between transmission type and gas mileage. On average, cars with manual transmission also get better gas mileage.
